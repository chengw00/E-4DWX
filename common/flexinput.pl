...
#
# The base directory for the codebase
...
$DATADIR = "$BASE_DIR/$ENV{LOGNAME}/datainput";
...
#
#$MustHaveDir = $CSH_ARCHIVE."/util/MustHaveDir";

#
# The 'CheckConfigFiles' script
#
$CheckConfigFiles = $CSH_ARCHIVE."/util/CheckConfigFiles";
...
#
$mods_flexinput = $flexinput_dir . "flexinput.mods.pm";
if ( -e $mods_flexinput ) {
  require "$mods_flexinput" ;
}
else {
  $log_message = " === INFO === Not included $mods_flexinput\n";
  print        $log_message;
  print STDERR $log_message;
}
