...
$DISTRIB_ROOT = "SEDBASEDIR/$ENV{LOGNAME}/distrib";
# create sha sums on output files (implies tarring of image directories first)
$DO_TAR_SUM_FOR_DISTRIB = SEDDOTARSUMFORDISTRIB;
...
$GRIB_DEST_ROOT = "/raid/wrf/grib";
$GRIB_DEST_KEY  = "/home/$ENV{LOGNAME}/.ssh/rtfdda-atc";
